				...
				<div class="row">
					<main id="articleContainer" class="col-md-8 main-content" style="">
						<!-- <article class="myarticle">
							<div class="author">
								<a href="#"><img class="img-circle" src="static/img/user/1.jpg"/></a>
								<span>Tom</span>
							</div>
							<div class="article_content">
							...
							<div class="article_footer">
								<ul class="nav navbar-nav">
									<li><a href="#">赞<img class="jdugePic" src="${base}/static/img/sys/good.png"></img></a></li>
									<li><a href="#">呵呵<img class="jdugePic" src="${base}/static/img/sys/bad.png"></img></a></li>
								</ul>
							</div>
						</article> -->
